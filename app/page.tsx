    ...
    >
      ...
      >
        ...
        <a
          href="/"
          id="nav-logo"
          aria-label="JJ Pools and SPA — Home"
          style={{
            textDecoration: "none",
            display: "flex",
            alignItems: "center",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontWeight: 400,
                  background:
                    "linear-gradient(135deg, #2dd4bf 0%, #22d3ee 60%, #5eead4 100%)",
            ...
            {/* CTAs */}
            <div id="hero-ctas" className="hero-ctas animate-fade-up delay-500">
              {/* Primary CTA */}
              <a
      ...
      >
        ...
        >
          ...
          <h2
            className="animate-fade-up text-4xl md:text-[3.5rem]"
            style={{
              fontFamily: "var(--font-outfit), sans-serif",
              fontWeight: 800,
          ...
          >
            Whether you're drawn to engineered simplicity or hand-crafted
            artistry, every JJ project is built to elevate the way you live
            outdoors.
          </p>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(2,10,24,0.85) 0%, transparent 60%)",
                    }}
                  />
                  <h3
                    style={{
      ...
      >
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div
            className="process-header-mobile"
          ...
          >
            ...
            >
              No subcontractor chasing. No permit headaches. No surprise costs.
              Just one trusted team, one timeline, and one beautifully finished
              backyard.
            </p>
          </div>
            ...
            {[
              {
                num: "01",
                title: "Design",
                text: "3D concepts crafted around your home, lifestyle, and lot.",
                icon: (
                  <HiOutlinePencilAlt
                    size={32}
              ...
              },
              {
                num: "02",
                title: "Permits",
                text: "We handle every Florida permit and HOA requirement.",
                icon: (
                  <HiOutlineDocumentText
                    size={32}
                    style={{ stroke: "url(#icon-gradient)" }}
              ...
              },
              {
                num: "03",
                title: "Engineering",
                text: "Precision plans engineered for durability and beauty.",
                icon: (
                  <HiOutlineClipboardList
                    size={32}
                    style={{ stroke: "url(#icon-gradient)" }}
              ...
              },
              {
                num: "04",
                title: "Installation",
                text: "Skilled crews, transparent timelines, zero surprises.",
                icon: (
                  <FiTool size={32} style={{ stroke: "url(#icon-gradient)" }} />
                ),
              },
              {
                num: "05",
                title: "Finishing",
                text: "Decking, lighting, landscaping — the resort experience.",
                icon: (
                  <HiOutlineSparkles
                    size={32}
                    style={{ stroke: "url(#icon-gradient)" }}
              ...
              },
              {
                num: "06",
                title: "Project Mgmt",
                text: "One dedicated point of contact. Start to dive in.",
                icon: (
                  <FiSettings
                    size={32}
                    style={{ stroke: "url(#icon-gradient)" }}
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      right: "-8px",
                      background:
                        "linear-gradient(135deg, #0f385c 0%, #1cb5e0 100%)",
                      color: "#ffffff",
                      width: "28px",
                      height: "28px",
                      borderRadius: "50%",
        ...
        >
          ...
          <div style={{ position: "relative", width: "100%" }}>
            ...
            >
              <Image
                src="/about-bg.png"
                alt="Family relaxing by pool"
                fill
                style={{ objectFit: "cover" }}
              />
            </div>
            <div
              className="about-badge-mobile"
              style={{
                position: "absolute",
                bottom: "-2rem",
                right: "-2rem",
          ...
          <div>
            ...
            >
              Headquartered in Winter Garden, JJ Pools & Spa is part of an
              established group with deep expertise in residential construction
              and vacation home management. We bring that operational discipline
              — and that hospitality mindset — to every backyard we transform.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Powered by a larger group specialized in home construction and vacation home management.",
                  icon: <HiOutlineOfficeBuilding size={24} />,
                },
                {
                  title: "Quality without compromise",
                  desc: "Premium materials, certified crews, and a build standard you can verify.",
                  icon: <HiOutlineShieldCheck size={24} />,
                },
                {
                  title: "Transparent communication",
                  desc: "Real updates, real timelines, and a project manager who actually answers.",
      ...
      >
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <h2
            className="reasons-heading-mobile"
            style={{
              fontFamily: "var(--font-outfit), sans-serif",
              fontWeight: 800,
              fontSize: "3.25rem",
          ...
          >
            Eight reasons your backyard deserves{" "}
            <span
              style={{
                color: "#2dd4bf",
                fontStyle: "italic",
            ...
            {[
              {
                ...
                desc: "One contract. One team. Zero coordination on you.",
                icon: <TbAffiliate size={20} />,
              },
              {
                title: "Premium Finishes",
                desc: "Materials and details selected for lasting beauty.",
                icon: <TbDiamond size={20} />,
              },
              {
                title: "Fast Communication",
                desc: "Direct access to your project manager — always.",
                icon: <TbMessageCircle size={20} />,
              },
              {
                title: "Financing Options",
                desc: "Flexible plans that fit your timeline and budget.",
                icon: <TbWallet size={20} />,
              },
              {
                title: "High-End Design",
                desc: "Architecturally considered, lifestyle-driven concepts.",
                icon: <TbCompass size={20} />,
              },
              {
                title: "Stress-Free Build",
                desc: "We absorb the complexity. You enjoy the result.",
                icon: <TbSparkles size={20} />,
              },
              {
                title: "Personalized Projects",
                desc: "Tailored to your home, family, and lifestyle.",
                icon: <TbUserCheck size={20} />,
              },
              {
                title: "Florida Expertise",
                desc: "Built for our climate, codes, and outdoor living.",
                icon: <TbSun size={20} />,
              },
            ].map((reason, i) => (
              <div
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, rgba(255,255,255,0.05) 0%, #1cb5e0 100%)",
                    boxShadow: "none",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
      ...
      >
        ...
        <div
          className="lifestyle-gradient-mobile"
          style={{
            position: "absolute",
            top: 0,
            left: 0,
            ...
            width: "70%",
            background:
              "linear-gradient(90deg, rgba(2,10,24,0.95) 0%, rgba(2,10,24,0.7) 45%, transparent 100%)",
            zIndex: 1,
          }}
        />
        ...
        >
          <div style={{ maxWidth: "600px" }}>
            ...
            >
              <span
                className="lifestyle-heading-mobile"
                style={{ fontWeight: 800, fontSize: "4rem", display: "block" }}
              >
                More than a pool.
              </span>
              <span
            ...
            >
              Sunset dinners. Weekend mornings with the kids. The friends who
              never want to leave. A JJ backyard becomes the favorite room of
              the house — and quietly raises the value of everything around it.
            </p>

            <div
              className="lifestyle-stats-mobile"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            width: "100%",
            boxShadow:
              "0 25px 50px -12px rgba(0,0,0,0.06), 0 0 40px 10px rgba(45,212,191,0.04)",
            gap: "4rem",
            alignItems: "center",
          }}
        >
          ...
          <div>
            ...
            {/* Headline */}
            <h2
              className="financing-heading-mobile"
              style={{
                fontFamily: "var(--font-outfit), sans-serif",
                fontWeight: 800,
                fontSize: "3.25rem",
            ...
            >
              Flexible financing options make resort-level outdoor living
              accessible. Speak with our team about plans tailored to your
          ...
          >
            <a
              href="/contact#inline-fadezkmGpuqGdxxebKZl"
              style={{
                display: "flex",
                alignItems: "center",
                justifyContent: "space-between",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 15px 25px -5px rgba(45,212,191,0.3)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 10px 20px -5px rgba(45,212,191,0.2)";
              }}
            >
            ...
            >
              ...
              <span
                style={{ color: "#64748b", display: "flex", width: "18px" }}
              >
                <IconArrow />
              </span>
            </a>
      ...
      >
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          >
            Request your free consultation today. A JJ specialist will reach out
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Premium fiberglass pools, ceramic pools and luxury spas. Complete
              turnkey backyard transformations across Florida.
            </p>
            <div style={{ display: "flex", gap: "1rem" }}>
              <a
                href="https://www.instagram.com/jjpools.spa"
                target="_blank"
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "#1cb5e0";
                  e.currentTarget.style.color = "#1cb5e0";
                }}
                onMouseLeave={(e) => {
              ...
              <a
                href="https://www.facebook.com/jjpoolsandspa"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  width: "40px",
        ...
        >
          ...
          >
            © 2026 JJ Pools & Spa. All rights reserved.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <span style={{ color: "rgba(255,255,255,0.5)" }}>
              Licensed & Insured - Winter Garden, FL
            </span>
          </div>
        </div>
      </footer>
